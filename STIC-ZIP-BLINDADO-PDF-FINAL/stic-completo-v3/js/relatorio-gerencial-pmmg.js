...
<div class="relatorio-pmmg">
    ...
    <div class="acoes-relatorio-pmmg">
        <button class="btn-pmmg btn-pmmg-primario" style="display:none">
            🖨️ Imprimir Relatório
        </button>
        <button class="btn-pmmg btn-pmmg-secundario" onclick="STIC.exportarRelatorioPDF()">
            📄 Exportar PDF
        </button>
    </div>
 ...
 */
    ...
    relatorio.style.height = 'auto';
    relatorio.style.overflow = 'visible';

    const clone = relatorio.cloneNode(true);
    ...
    setTimeout(() => {
        html2pdf().from(clone).set({
            margin: 10,
            filename: 'relatorio-gerencial-stic.pdf',
            html2canvas: {
                scale: 2,
                useCORS: true,
                scrollY: 0
...
window.STIC.exportarRelatorioPDF = function () {
    const relatorio = document.querySelector('.relatorio-pmmg');
