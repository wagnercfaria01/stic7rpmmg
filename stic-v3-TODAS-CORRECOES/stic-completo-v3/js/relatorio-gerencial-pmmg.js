...
function imprimirRelatorio() {
    // Criar janela de impressão com o relatório
...
async function exportarRelatorioPDF() {
    ...
    try {
        ...
        if (typeof window.jspdf === 'undefined') {
            alert('Biblioteca PDF não carregada. Use "Imprimir" e salve como PDF.');
            return;
        }
        ...
        // Usar html2canvas para converter HTML em imagem
        if (typeof html2canvas !== 'undefined') {
            ...
            pdf.save('relatorio-gerencial-pmmg.pdf');
            
        } else {
            // Fallback: texto simples
            alert('Use "Imprimir" e selecione "Salvar como PDF" para melhor resultado.');
            imprimirRelatorio();
        }
        
    } catch (error) {
        console.error('Erro ao gerar PDF:', error);
        alert('Erro ao gerar PDF. Use "Imprimir" e salve como PDF.');
    }
}
